...
* Making a blog with Emacs, Hugo, and builds.sr.ht               :emacs:meta:
  ...
  :END:
Today I decided to setup a blog where I can more publically voice my opinions, whether they be tech-related or not. I decided to make this short first blog post to share some of the code behind this blog, if anyone else out there wants to setup a blog like this one.
